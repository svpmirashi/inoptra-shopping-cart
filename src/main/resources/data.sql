...
--VALUES (100, 'iPhone 12 Pro Max', 'iPhone 12 Pro Max', 'iPhone', 'Black', 139900, 1, '2022-05-01', '2022-05-15', 'testUser1', '2022-08-06', 'testUser1', '2022-08-06');
--INSERT INTO PRODUCT_ITEM (product_item_id, name, title, brand, color, base_price, vendor_id, mfg_date, expiry_date, created_by, created_date, modified_by, modified_date)
...
--INSERT INTO PRODUCT_ITEM (product_item_id, name, title, brand, color, base_price, vendor_id, mfg_date, expiry_date, created_by, created_date, modified_by, modified_date)
--VALUES (104, 'OnePlus 10R', 'OnePlus 10R', 'OnePlus', 'Grey', 34700, 2, '2022-04-01', '2022-04-15', 'testUser2', '2022-08-06', 'testUser2', '2022-08-06');
--INSERT INTO PRODUCT_ITEM (product_item_id, name, title, brand, color, base_price, vendor_id, mfg_date, expiry_date, created_by, created_date, modified_by, modified_date)
--VALUES (105, 'OnePlus 10R', 'OnePlus 10R', 'OnePlus', 'Blue', 33999, 1, '2022-04-01', '2022-04-15', 'testUser2', '2022-08-06', 'testUser2', '2022-08-06');
--INSERT INTO PRODUCT_ITEM (product_item_id, name, title, brand, color, base_price, vendor_id, mfg_date, expiry_date, created_by, created_date, modified_by, modified_date)
--VALUES (106, 'OnePlus 10R', 'OnePlus 10R', 'OnePlus', 'Red', 34890, 1, '2022-04-01', '2022-04-15', 'testUser2', '2022-08-06', 'testUser2', '2022-08-06');
...
VALUES (100, 'iPhone 12 Pro Max', 'iPhone', 'Black', 139900, 'MOBILE_AND_ACCESSORIES', '2022-05-01', '2022-05-15', 'testUser1', '2022-08-06', 'testUser1', '2022-08-06');
INSERT INTO PRODUCT_META (product_item_id, title, brand, color, base_price, category, mfg_date, expiry_date, created_by, created_date, modified_by, modified_date)
...
INSERT INTO SHOPPING_CART_PRODUCT_ITEM (shopping_cart_id, product_item_id)
VALUES (1001, 100);
INSERT INTO SHOPPING_CART_PRODUCT_ITEM (shopping_cart_id, product_item_id)
VALUES (1001, 106);
INSERT INTO SHOPPING_CART_PRODUCT_ITEM (shopping_cart_id, product_item_id)
